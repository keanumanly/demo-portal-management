...
export default function AnalyticsPage() {
  ...
  // Summary KPIs — with fake prev-period delta
  const kpis = [
    { label: "Total Calls",      value: totalCalls,         unit: "",    delta: +12, icon: Phone,      color: "from-cyan-500 to-blue-500" },
    { label: "Avg Duration",     value: "7m 14s",           unit: "",    delta: -8,  icon: Clock,      color: "from-violet-500 to-purple-500", deltaGood: "down" },
    { label: "FCR Rate",         value: `${fcrRate}%`,      unit: "",    delta: +5,  icon: Target,     color: "from-emerald-500 to-teal-500" },
    { label: "Avg QA Score",     value: 80,                 unit: "/100",delta: +6,  icon: Star,       color: "from-amber-500 to-orange-500" },
    { label: "Agents Active",    value: AGENTS.length,      unit: "",    delta: 0,   icon: Users,      color: "from-slate-500 to-slate-400" },
