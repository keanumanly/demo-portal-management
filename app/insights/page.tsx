...
const HOUR_HEATMAP: number[] = [2,5,8,12,18,24,28,31,42,58,71,68,62,55,60,64,59,52,44,35,22,14,8,4];
...
const SEVERITY_CONFIG: Record<Severity, { border: string; bg: string; icon: string; badge: string; label: string }> = {
...
const TYPE_ICON: Record<InsightCard["type"], React.ElementType> = {
